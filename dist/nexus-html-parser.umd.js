(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@sethorax/nexus')) :
    typeof define === 'function' && define.amd ? define(['exports', '@sethorax/nexus'], factory) :
    (factory((global.nexusHtmlParser = {}),global.nexus));
}(this, (function (exports,nexus) { 'use strict';
    ...
    var NexusHTMLParser = /** @class */ (function (_super) {
        ...
        NexusHTMLParser.prototype.parse = function (rawData) {
            ...
            if (contentRoot) {
                ...
                throw new nexus.NexusParseError("No match for selector " + contentRootSelector + " found!");
            }
        };
